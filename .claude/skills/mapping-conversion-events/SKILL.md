...
description: |
  Defines funnel events, tracking, and success signals. Use when: Marketing work needs defines funnel events, tracking, and success signals.
allowed-tools: Read, Edit, Write, Glob, Grep, Bash
---

# Mapping Conversion Events

Advisory marketing skill for Founder/Pro operators. Use when: defines funnel events, tracking, and success signals.

## Module

- Operating layer: Marketing
- Focus: Defines funnel events, tracking, and success signals.

## When To Use

- Defines funnel events, tracking, and success signals.
