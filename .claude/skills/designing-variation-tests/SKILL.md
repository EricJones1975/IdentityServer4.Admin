...
description: |
  Plans A/B experiments and measurement plans. Use when: Marketing work needs plans a/b experiments and measurement plans.
allowed-tools: Read, Edit, Write, Glob, Grep, Bash
---

# Designing Variation Tests

Advisory marketing skill for Founder/Pro operators. Use when: plans a/b experiments and measurement plans.

## Module

- Operating layer: Marketing
- Focus: Plans A/B experiments and measurement plans.

## When To Use

- Plans A/B experiments and measurement plans.
