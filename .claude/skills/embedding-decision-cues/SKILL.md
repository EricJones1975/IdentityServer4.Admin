...
description: |
  Applies behavioral cues that improve conversion decisions. Use when: Marketing work needs applies behavioral cues that improve conversion decisions.
allowed-tools: Read, Edit, Write, Glob, Grep, Bash
---

# Embedding Decision Cues

Advisory marketing skill for Founder/Pro operators. Use when: applies behavioral cues that improve conversion decisions.

## Module

- Operating layer: Marketing
- Focus: Applies behavioral cues that improve conversion decisions.

## When To Use

- Applies behavioral cues that improve conversion decisions.
