...
description: |
  Generates channel experiments and growth loops. Use when: Marketing work needs generates channel experiments and growth loops.
allowed-tools: Read, Edit, Write, Glob, Grep, Bash
---

# Generating Growth Hypotheses

Advisory marketing skill for Founder/Pro operators. Use when: generates channel experiments and growth loops.

## Module

- Operating layer: Marketing
- Focus: Generates channel experiments and growth loops.

## When To Use

- Generates channel experiments and growth loops.
