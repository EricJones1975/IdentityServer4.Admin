...
description: |
  Defines product events, funnels, and activation metrics. Use when: Product work needs defines product events, funnels, and activation metrics.
allowed-tools: Read, Edit, Write, Glob, Grep, Bash
---

# Instrumenting Product Metrics

Advisory product skill for Founder/Pro operators. Use when: defines product events, funnels, and activation metrics.

## Module

- Operating layer: Product
- Focus: Defines product events, funnels, and activation metrics.
