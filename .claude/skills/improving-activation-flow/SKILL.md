...
description: |
  Optimizes activation steps and time-to-value milestones. Use when: Product work needs optimizes activation steps and time-to-value milestones.
allowed-tools: Read, Edit, Write, Glob, Grep, Bash
---

# Improving Activation Flow

Advisory product skill for Founder/Pro operators. Use when: optimizes activation steps and time-to-value milestones.

## Module

- Operating layer: Product
- Focus: Optimizes activation steps and time-to-value milestones.
