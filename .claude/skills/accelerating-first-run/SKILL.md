...
description: |
  Improves onboarding sequence and time-to-value. Use when: Marketing work needs improves onboarding sequence and time-to-value.
allowed-tools: Read, Edit, Write, Glob, Grep, Bash
---

# Accelerating First Run

Advisory marketing skill for Founder/Pro operators. Use when: improves onboarding sequence and time-to-value.

## Module

- Operating layer: Marketing
- Focus: Improves onboarding sequence and time-to-value.

## When To Use

- Improves onboarding sequence and time-to-value.
