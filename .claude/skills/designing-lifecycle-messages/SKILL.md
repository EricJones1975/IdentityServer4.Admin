...
description: |
  Designs onboarding and lifecycle email sequences. Use when: Marketing work needs designs onboarding and lifecycle email sequences.
allowed-tools: Read, Edit, Write, Glob, Grep, Bash
---

# Designing Lifecycle Messages

Advisory marketing skill for Founder/Pro operators. Use when: designs onboarding and lifecycle email sequences.

## Module

- Operating layer: Marketing
- Focus: Designs onboarding and lifecycle email sequences.

## When To Use

- Designs onboarding and lifecycle email sequences.
