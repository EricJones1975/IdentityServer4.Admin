...
description: |
  Reduces friction in signup and trial activation. Use when: Marketing work needs reduces friction in signup and trial activation.
allowed-tools: Read, Edit, Write, Glob, Grep, Bash
---

# Streamlining Signup Steps

Advisory marketing skill for Founder/Pro operators. Use when: reduces friction in signup and trial activation.

## Module

- Operating layer: Marketing
- Focus: Reduces friction in signup and trial activation.
