...
description: |
  Sets up product experiments and rollout checks. Use when: Product work needs sets up product experiments and rollout checks.
allowed-tools: Read, Edit, Write, Glob, Grep, Bash
---

# Running Product Experiments

Advisory product skill for Founder/Pro operators. Use when: sets up product experiments and rollout checks.

## Module

- Operating layer: Product
- Focus: Sets up product experiments and rollout checks.

## When To Use

- Sets up product experiments and rollout checks.
