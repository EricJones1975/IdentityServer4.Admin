...
description: |
  Aligns paid acquisition with landing pages and pixels. Use when: Marketing work needs aligns paid acquisition with landing pages and pixels.
allowed-tools: Read, Edit, Write, Glob, Grep, Bash
---

# Calibrating Paid Campaigns

Advisory marketing skill for Founder/Pro operators. Use when: aligns paid acquisition with landing pages and pixels.

## Module

- Operating layer: Marketing
- Focus: Aligns paid acquisition with landing pages and pixels.

## When To Use

- Aligns paid acquisition with landing pages and pixels.
