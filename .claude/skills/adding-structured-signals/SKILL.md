...
description: |
  Adds structured data for rich results. Use when: SEO work needs adds structured data for rich results.
allowed-tools: Read, Edit, Write, Glob, Grep, Bash
---

# Adding Structured Signals

Advisory seo skill for Founder/Pro operators. Use when: adds structured data for rich results.

## Module

- Operating layer: SEO
- Focus: Adds structured data for rich results.
