...
description: |
  Defines content themes, briefs, and editorial cadence. Use when: Marketing work needs defines content themes, briefs, and editorial cadence.
allowed-tools: Read, Edit, Write, Glob, Grep, Bash
---

# Planning Editorial Arcs

Advisory marketing skill for Founder/Pro operators. Use when: defines content themes, briefs, and editorial cadence.

## Module

- Operating layer: Marketing
- Focus: Defines content themes, briefs, and editorial cadence.

## When To Use

- Defines content themes, briefs, and editorial cadence.
