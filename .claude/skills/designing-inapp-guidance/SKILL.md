...
description: |
  Builds tooltips, tours, and contextual guidance. Use when: Product work needs builds tooltips, tours, and contextual guidance.
allowed-tools: Read, Edit, Write, Glob, Grep, Bash
---

# Designing Inapp Guidance

Advisory product skill for Founder/Pro operators. Use when: builds tooltips, tours, and contextual guidance.

## Module

- Operating layer: Product
- Focus: Builds tooltips, tours, and contextual guidance.
