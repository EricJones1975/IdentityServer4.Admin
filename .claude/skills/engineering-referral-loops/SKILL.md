...
description: |
  Designs referral or partner loop mechanics. Use when: Marketing work needs designs referral or partner loop mechanics.
allowed-tools: Read, Edit, Write, Glob, Grep, Bash
---

# Engineering Referral Loops

Advisory marketing skill for Founder/Pro operators. Use when: designs referral or partner loop mechanics.

## Module

- Operating layer: Marketing
- Focus: Designs referral or partner loop mechanics.
