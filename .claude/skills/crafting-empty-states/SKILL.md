...
description: |
  Creates empty states and onboarding affordances. Use when: Product work needs creates empty states and onboarding affordances.
allowed-tools: Read, Edit, Write, Glob, Grep, Bash
---

# Crafting Empty States

Advisory product skill for Founder/Pro operators. Use when: creates empty states and onboarding affordances.

## Module

- Operating layer: Product
- Focus: Creates empty states and onboarding affordances.

## When To Use

- Creates empty states and onboarding affordances.
