...
description: |
  Improves lead capture forms to reduce drop-off. Use when: Marketing work needs improves lead capture forms to reduce drop-off.
allowed-tools: Read, Edit, Write, Glob, Grep, Bash
---

# Reducing Form Falloff

Advisory marketing skill for Founder/Pro operators. Use when: improves lead capture forms to reduce drop-off.

## Module

- Operating layer: Marketing
- Focus: Improves lead capture forms to reduce drop-off.
