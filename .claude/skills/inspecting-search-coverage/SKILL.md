...
description: |
  Audits technical and on-page search coverage. Use when: SEO work needs audits technical and on-page search coverage.
allowed-tools: Read, Edit, Write, Glob, Grep, Bash
---

# Inspecting Search Coverage

Advisory seo skill for Founder/Pro operators. Use when: audits technical and on-page search coverage.

## Module

- Operating layer: SEO
- Focus: Audits technical and on-page search coverage.
