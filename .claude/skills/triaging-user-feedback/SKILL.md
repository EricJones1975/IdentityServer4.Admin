...
description: |
  Routes feedback into backlog and quick wins. Use when: Product work needs routes feedback into backlog and quick wins.
allowed-tools: Read, Edit, Write, Glob, Grep, Bash
---

# Triaging User Feedback

Advisory product skill for Founder/Pro operators. Use when: routes feedback into backlog and quick wins.

## Module

- Operating layer: Product
- Focus: Routes feedback into backlog and quick wins.

## When To Use

- Routes feedback into backlog and quick wins.
