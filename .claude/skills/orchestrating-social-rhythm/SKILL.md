...
description: |
  Plans social content beats and distribution rhythm. Use when: Marketing work needs plans social content beats and distribution rhythm.
allowed-tools: Read, Edit, Write, Glob, Grep, Bash
---

# Orchestrating Social Rhythm

Advisory marketing skill for Founder/Pro operators. Use when: plans social content beats and distribution rhythm.

## Module

- Operating layer: Marketing
- Focus: Plans social content beats and distribution rhythm.

## When To Use

- Plans social content beats and distribution rhythm.
