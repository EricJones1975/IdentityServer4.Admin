...
description: |
  Aligns ICP, positioning, and value narrative for on-page messaging. Use when: Marketing work needs aligns icp, positioning, and value narrative for on-page messaging.
allowed-tools: Read, Edit, Write, Glob, Grep, Bash
---

# Clarifying Market Fit

Advisory marketing skill for Founder/Pro operators. Use when: aligns icp, positioning, and value narrative for on-page messaging.

## Module

- Operating layer: Marketing
- Focus: Aligns ICP, positioning, and value narrative for on-page messaging.
