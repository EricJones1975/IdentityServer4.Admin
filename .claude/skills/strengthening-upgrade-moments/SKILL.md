...
description: |
  Improves upgrade prompts and paywall messaging. Use when: Marketing work needs improves upgrade prompts and paywall messaging.
allowed-tools: Read, Edit, Write, Glob, Grep, Bash
---

# Strengthening Upgrade Moments

Advisory marketing skill for Founder/Pro operators. Use when: improves upgrade prompts and paywall messaging.

## Module

- Operating layer: Marketing
- Focus: Improves upgrade prompts and paywall messaging.
